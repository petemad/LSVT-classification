...
%%Naive Bayes
    ...
    Icorr1 = maxCorr(abs(corrNB),5);% gets indices of 5 features with max corrCoeff
    [accCorNB, senCorNB, specCorNB] = maxParam(X(:,Icorr1),Y, fun);
...
%%K-Nearest Neighbours
    ...
    %%%Using Correlation between each of 310 features and the response
    [accCorKN, senCorKN, specCorKN] = maxParam(X(:,Icorr1),Y, fun);
    %%%Using all 310 features
